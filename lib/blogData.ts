const blogPosts = [
  {
    id: 1,
    title: "راهنمای جامع طبقه بندی کلمات یا Text Classification",
    summary:
  ...
  // {
  //   id: 2,
  //   title: "راهنمای جامع طبقه بندی صدا یا Audio Classification",
  //   summary:
  //     "در این مقاله ، راهنمای کاملی برای طبقه بندی صدا یا Audio Classification در زمینه هوش مصنوعی و داده کاوی ارائه می‌شود.",
  //   date: "1403/10/3",
  //   link: "/blogs/2",
