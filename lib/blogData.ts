const blogPosts = [
  ...
  {
    id: 2,
    title: "تحلیل رگرسیون ها یا Regression Analysis چیست و چه کار برد هایی دارد",
    summary:
      "",
    date: "1403/10/13",
    link: "/blogs/a-beginners-guide-about-what-is-regresion-and-when-does-it-used-in-persian-language",
