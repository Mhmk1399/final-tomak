...
const featureBox = [
  {
    ...
    description: "طراحی گرافیکی با حرفه ای بودن و کیفیت بالا",
    icon: "/assets/images/unique.png",
  },
  {
    title: " مفاهیم خلاقانه",
    description: "طراحی لوگو با حرفه ای بودن و کیفیت بالا",
    icon: "/assets/images/creative.png",
  },
  {
    title: " برندسازی سفارشی",
    description: "طراحی پوستر با حرفه ای بودن و کیفیت بالا",
