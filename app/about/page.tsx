  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "تومک یک تیم جوان، پویا و خلاق است که خدمات متنوعی در حوزه بازاریابی دیجیتال شامل تولید ویدئو، طراحی وبسایت، مدیریت کمپین‌های تبلیغاتی و تحلیل داده‌ها ارائه می‌دهد."
      );
    }
  }, []);
    ...
    >
      ...
      >
        ...
        <p className="text-lg text-white/90 mb-6 p-8 text-justify rounded-xl bg-white/30">
          تومک تیمی جوان، پویا و خلاق است که با تکیه بر دانش فنی و تخصص در حوزه‌های مختلف، خدمات جامعی را در بازاریابی دیجیتال ارائه می‌دهد. خدمات ما شامل طراحی و توسعه وبسایت‌های مدرن، تولید محتوای ویدئویی حرفه‌ای، مدیریت کمپین‌های تبلیغاتی هدفمند و تحلیل داده‌ها به منظور بهبود استراتژی‌های بازاریابی دیجیتال است. تیم تومک همواره در تلاش است تا با ایده‌های نوآورانه و رویکردهای خلاقانه، به موفقیت مشتریان خود در فضای دیجیتال کمک کند.
        </p>
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-gray-200 text-base text-justify p-4">
            تومک با ارائه خدمات دیجیتال مارکتینگ، به کسب‌وکارها کمک می‌کند تا با ایده‌های خلاقانه و استراتژی‌های هدفمند، در فضای دیجیتال رشد کنند. ما به کسب‌وکارهای کوچک و بزرگ کمک می‌کنیم تا از طریق بازاریابی دیجیتال، به موفقیت‌های جدید دست یابند و با بهره‌گیری از دانش فنی و تخصصی تیم ما، به اهداف خود نزدیک‌تر شوند.
          </p>
        </div>
