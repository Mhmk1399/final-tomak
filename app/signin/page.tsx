...
const Login: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 sm:gap-8 w-full max-w-lg sm:max-w-xl lg:max-w-5xl lg:my-24 my-64 ">
        <section
          id="back-div"
          className="rounded-3xl w-full lg:p-6 shadow-xl backdrop-blur-sm  mt-44"
        >
